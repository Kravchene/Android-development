...
class Bus : Transport(10),MyInterface {
    override fun drive() {
        println("The bus is traveling on the road")
    }

    override fun transportStop() {
        println("Bus stop")
    }
}

class Car :Transport(5),MyInterface {
    override fun drive() {
        println("The Car is traveling on the road")
    }
...
object VehiclesTest {
    ...
    private fun testBusParts() {
        ...
        val bus=Bus()
        val busMyInterface:MyInterface=bus
        val busDriveable :Driveable= bus
        busDriveable.drive()
        busMyInterface.transportStop()
