        ...
        while (true) {
            ...
            if (true) {
                if (randomNumber == userInput) {
                    ...
                    break
                } else if (randomNumber > userInput) print("Ваше число меньше задуманного, пожалуйста продолжаем.")
                else print("Ваше число больше задуманного, пожалуйста продолжаем.")
            }
        }
    }
