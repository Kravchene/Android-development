...
class Person(phoneCode: String) {
    ...
    companion object {
        val companionObject= companionConstant
        const val maxLength = 12
    }

    //TODO 3: Сделай эту функцию расширением листа вне класса Person
  private  fun MutableList<Any>.replacePlacesWithThePhoneCode(placeNum: Int = 3): List<Any> {
        return this.mapIndexed { index, any -> if (index % placeNum == 0) code else any}
    }
